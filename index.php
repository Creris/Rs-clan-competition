...
<!-- Optional theme -->
<link rel="stylesheet" href="common/bootstrap-3.3.6-dist/3.2.0/css/bootstrap-theme.min.css">

<link rel="stylesheet" type="text/css" href="rs_hs_images/style.css">

<!-- DataTables CSS -->
<link rel="stylesheet" type="text/css" href="rs_hs_images/tables.css">
  
<!-- DataTables -->
<script type="text/javascript" charset="utf8" src="rs_hs_images/tables.js"></script>

</head>
<body>

<?php
	include 'rs_hs_images/funcs.php';
			...
			<div id="innerRight">
				<table id="tab" class="table table-striped table-bordered table-hover">
					...
					<?php
						...
						$rank = formatString($ranks[$iterNum]);
						$level = formatString($levels[$iterNum]);
						$exp = formatString($exps[$iterNum]);
						...
						echo "<td class='text-center' ".$colorMaxVirtual.">".formatString($virtualTotalLevel)."</td>\n";
						...
						for($i = $iterNum; $i < $skillsCount; ++$i)
						{
							...
							$rank = formatString($ranks[$i]);
							
							$level = formatString($levels[$i]);
							$exp = $exps[$i];
							...
							echo "<td class='text-center'".$colorMax.">".formatString($exp)."</td>\n";
							echo "<td class='text-center'>".formatString($toNextLevel)."</td>\n";
